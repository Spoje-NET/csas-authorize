...
if (empty($tokenId) || empty($envFile)) {
    echo "Usage: php csas-access-token --tokenId=<TOKEN_ID> [--output=<OUTPUT_FILE>] [--environment=<ENVIRONMENT>] [--list] [--json]\n";
    echo "Options:\n";
    ...
    echo "  --json, -j           Export token data in JSON format (optional)\n";
